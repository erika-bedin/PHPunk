...
function verificaNome() {
  ...
  if (valor_nome === "") {
    ...
    valor_nome.match(/^[A-Za-záàâãéèêíïóôõöúçñÁÀÂÃÉÈÍÏÓÔÕÖÚÇÑ ]+$/) &&
    valor_nome.length < 20
  ) {
...
function verificaSobrenome() {
  ...
  if (valor_sobrenome === "") {
    ...
    valor_sobrenome.match(/^[A-Za-záàâãéèêíïóôõöúçñÁÀÂÃÉÈÍÏÓÔÕÖÚÇÑ ]+$/) &&
    valor_sobrenome.length < 20
  ) {
...
function validandoEnvioFormulario(input1, input2, input3, input4) {
  ...
  if (
    papai_input1.classList.contains("sucesso") &&
    papai_input2.classList.contains("sucesso") &&
    papai_input3.classList.contains("sucesso") &&
    papai_input4.classList.contains("sucesso")
  ) {
